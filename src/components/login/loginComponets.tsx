...
export function ButtonLogin({ text }: TextButton) {
  return (
    <Pressable
      className="text-gray-300 border bg-teal-700 border-teal-700 w-96 rounded-full h-14 mt-8 flex items-center justify-center"
  ...
  return (
    <View className="flex-row gap-10 items-center">
      ...
      >
        ...
        <Text
          className="text-teal-700 text-center mt-2"
          style={{
            fontFamily: "Inter", // Família da fonte
            fontWeight: "700", // Peso da fonte
            letterSpacing: 1.3, // Espaçamento entre letras
